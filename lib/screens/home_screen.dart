          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Health Profile Management Card
                Card(
                  elevation: 2,
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                  child: InkWell(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 2),
                                Text(
                                  patientProfile.hasData
                                      ? 'Age: ${patientProfile.age.isEmpty ? "-" : patientProfile.age} • Meds: ${patientProfile.currentMedicines.length} • Allergies: ${patientProfile.allergies.length}'
                                      : 'Set allergies, current medicines & conditions',
                                  style: TextStyle(
                                    fontSize: 12,
                                    color: Colors.grey.shade600,
                                  ),
