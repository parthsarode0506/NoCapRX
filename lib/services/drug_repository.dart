...
class DrugRepository {
  static const List<DrugMetadata> _prebundledDrugs = [
    ...
    DrugMetadata(
      ...
      genes: ['CYP2D6'],
      requiredClinicalData: [],
      evidenceSource: 'CPIC Guideline for CYP2D6 and 5-HT3 receptor antagonists.',
      ruleAvailable: true,
    ...
    DrugMetadata(
      ...
      genes: [],
      requiredClinicalData: [],
      evidenceSource: 'Standard amoxicillin medicine safety information.',
      ruleAvailable: false,
    ...
    DrugMetadata(
      ...
      aliases: ['Azee 500', 'Azee', 'Atm 500', 'ATM500', 'Zithromax', 'Azithral', 'Z-Pak'],
      genes: [],
      requiredClinicalData: [],
      evidenceSource:
      ...
      seriousSideEffects: ['Severe allergic reaction', 'Irregular heartbeat', 'Severe or persistent diarrhea'],
      precautions: ['Use only for a bacterial infection diagnosed by a clinician'],
    ),
    DrugMetadata(
      ...
      seriousSideEffects: [
        'Liver injury after too much medicine or with alcohol',
        'Severe allergic reaction',
      ],
      precautions: [
